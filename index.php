...
<body>
  ...
  ?>
    ...
    <section id="banner" class="section-m1">
        ...
        <h2>Up to <span>70% off</span> - All Hand Tools</h2>
        <button class="normal"><a style="text-decoration:none; color:white;" href="shop.php">Explore More</a></button>
    </section>
  ...
  <div class="banner-box banner-box2">
    ...
    <h2>New Electrical Collection</h2>
    <h3>with 5-star rating</h3>
